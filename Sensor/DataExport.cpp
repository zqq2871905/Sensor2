...
*/
BOOL DataExport::ExportProfile(const PROFILE_DATA *profileData, QString strFileName, int nProfileCnt)
{
...
@return Did the export succeed?(True:Success)
*/
BOOL DataExport::ExportProfileEx(const PROFILE_DATA *profileData, QString strFileName, int nProfileCnt)
{
	CStringA strPathAnsi(strFileName);
	ofstream ofOutfile(strPathAnsi);
...
*/
BOOL DataExport::ExportMeasureDatas(vector<MEASURE_DATA> &vecMeasureData, QString strfileName)
{
	CStringA strPathAnsi(strfileName);
